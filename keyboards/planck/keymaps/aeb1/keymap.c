...
[_QWERTY] = {
	...
	{KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,   KC_N,   KC_M,  KC_DQUO, KC_DOT,  KC_UP,   KC_RSFT}, 
...
[_LOWER] = {
	...
	{KC_MINS, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PIPE}, 
	{KC_TRNS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_NO,   KC_NO,   KC_NO,   KC_QUOT,   KC_DOT, KC_HOME, KC_TRNS}, 
...
[_RAISE] = {
	...
	{KC_TRNS, KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, KC_NO,   KC_NO,   KC_NO,   KC_DQUO, KC_COMM, KC_PGUP, KC_TRNS}, 
...
[_ADJUST] = {
  ...
  {M(6), M(3),    M(4),    KC_BSPC, KC_DEL,  _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______},
